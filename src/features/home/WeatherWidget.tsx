...
export const WeatherWidget = () => {
  ...
  // 原 cmjh 彩色圖示：晴天系→黃色，降水系→藍/紫，雲/霧→灰色
  ...
  return (
    <section id="weather">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-lg font-bold text-foreground">天氣動態</h2>
          ...
          <CardContent className="p-4">
            {loading ? (
              ...
              <div className="space-y-4">
                <div className="relative overflow-hidden rounded-2xl bg-brand-soft border border-primary/10 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="p-2.5 rounded-2xl bg-primary/10 border border-primary/10">
